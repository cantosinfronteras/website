<template>
    <x-container class="flex flex-col gap-4 py-16">
        <h1 class="font-bold text-4xl">Políticas de privacidad y cookies</h1>
        <p>
            La presente Política de Privacidad establece los términos en que Canto Sin
            Fronteras usa y protege la información que es proporcionada por sus usuarios
            al momento de utilizar su sitio web. Esta compañía está comprometida con la
        ...
        <p>
            Canto Sin Fronteras está altamente comprometido para cumplir con el
        ...
        <p>
            ...
            puede cambiar la configuración de su ordenador para declinar las cookies. Si
        ...
        <p>
            Canto Sin Fronteras Se reserva el derecho de cambiar los términos de la
